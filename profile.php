                    ...
                    <div class="caption">
                      ...
                      <?php 
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td width="150"><img src="profilepic/<?=$profile?>" alt="profile pic"/></td>
                      ...
                      <?php echo '<td><a href="faq.php?sid='.$sid.'"><button>Comment</button></a></td>'; ?>
            ...
            <ul class="thumbnails">
                <li class="filterDiv Electrical Worker" class="span3">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      <h3>Fish Shop Keeper</h3>
                      <p>
                        Get plan, install and maintain electrical wiring systems across a wide variety of environments.
                      </p>
                      <?php 
                         $sql = "SELECT * FROM service_provider WHERE service_provider='Fish Shop Keeper'";
                         $reslt = mysqli_query($conn, $sql);
                ...
                <li class="filterDiv Electrical Worker" class="span3">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <?php 
                         $sql = "SELECT * FROM service_provider WHERE service_provider='Carpenter'";
                         $reslt = mysqli_query($conn, $sql);
                ...
                <li class="filterDiv Electrical Worker" class="span3">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <?php 
                         $sql = "SELECT * FROM service_provider WHERE service_provider='Cleaner'";
                         $reslt = mysqli_query($conn, $sql);
