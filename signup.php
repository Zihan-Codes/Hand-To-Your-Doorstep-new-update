                ...
                <form class="form-horizontal form-signin-signup" action="signup.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="text" name="L_Name" placeholder="Enter Your Last Name">
                   ...
                   <div class="district">
                     ...
                     <input class="dst" type="radio" name="District"  value="Colombo"> Colombo<br>
                     <input class="dst" type="radio" name="District"  value="Kaluthara"> Kaluthara<br>
                     <input class="dst" type="radio" name="District"  value="Gampaha"> Gampaha<br>
                   </div>
                    <br>
                  ...
                  <input type="text" name="Email" placeholder="Enter Your Email">
                   ...
                   <input  type="radio" name="User"  value="Service Provider" > Service Provider 
                    ...
                    <input  type="radio" name="service"  value="Cleaner"> Cleaner<br>
                    <input  type="radio" name="service"  value="Fish Shop Keeper"> Fish Shop Keeper<br>
